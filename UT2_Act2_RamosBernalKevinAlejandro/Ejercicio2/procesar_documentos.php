...
<div class="contenedor">
    ...
    <?php else: ?>
        <table>
            ...
            <tr><td>Autor/es</td><td><?php echo $autor; ?></td></tr>
            <tr><td>Nombre del documento</td><td><?php echo $nombre_documento; ?></td></tr>
            <tr><td>Descripcion</td><td><?php echo $descripcion; ?></td></tr>
            <tr><td>Tipo documento</td><td><?php echo $tipo_documento; ?></td></tr>
            <tr><td>Extensiones</td><td><?php echo implode(', ', $extensiones); ?></td></tr>
            <tr><td>Palabras clave</td><td><?php echo $palabras_clave; ?></td></tr>
            <tr><td>Idioma</td><td><?php echo $idioma; ?></td></tr>
            <tr><td>Visibilidad</td><td><?php echo $visibilidad; ?></td></tr>
            <tr><td>Tematica</td><td><?php echo implode(', ', $tematicas); ?></td></tr>
            <tr><th colspan="2">Archivos procesados</th></tr>
